...
<div class="page">
  ...
  <div class="paragraph custom-container" style="margin-top: 0.5cm;">
  ...
  <div class="paragraph custom-container" style="margin-top: 0.5cm;">
    ...
    <div class="radio-paragraph">
      <div class="radio-checkbox-row radio-checkbox-row-height">
    ...
    <div class="radio-paragraph">
      ...
      <div class="radio-text-first-row">4. motive justificate, precum îngrijirea/ însoțirea unui minor/copilului,
        asistența persoanelor vârstnice, bolnave sau cu dizabilități ori deces al unui membru de
        familie
      </div>
    </div>
    <div class="radio-paragraph">
      <div class="radio-checkbox-row" style="height: 50px;">
      ...
      <div class="radio-text-first-row">5. activitate fizică individuală (cu excluderea oricăror activități
        sportive de echipă/ colective) sau pentru nevoile animalelor de companie/domestice, în apropierea
        locuinței
      </div>
    </div>
    <div class="radio-paragraph">
  ...
  <div style="font-weight: bold; font-size: 16px; width: 92%;">Persoanele care au împlinit vârsta de 65 de ani
    completează doar
