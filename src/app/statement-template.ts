...
<div class="page">
  ...
  <div class="paragraph custom-container" style="margin-top: 0.8cm;">
  ...
  <div class="paragraph custom-container" style="margin-top: 0.8cm;">
    ...
    <div class="radio-paragraph">
      <div class="radio-checkbox-row">
        <div class="radio {{reason_1}}"></div>
      </div>
      <div class="radio-text-first-row">1. interes profesional, inclusiv între locuință/gospodărie și
        locul/locurile de desfășurare
      </div>
      <div class="radio-text-row"> a activității profesionale și înapoi</div>
    </div>
    <div class="radio-paragraph">
      <div class="radio-checkbox-row">
        <div class="radio {{reason_2}}"></div>
      </div>
      <div class="radio-text-first-row">2. asigurarea de bunuri care acoperă necesitățile de bază ale persoanelor
        și animalelor
      </div>
      <div class="radio-text-row">de companie/domestice</div>
    </div>
    <div class="radio-paragraph">
      <div class="radio-checkbox-row">
        <div class="radio {{reason_3}}"></div>
      </div>
    ...
    <div class="radio-paragraph">
      <div class="radio-checkbox-row">
        <div class="radio {{reason_4}}"></div>
      </div>
      <div class="radio-text-first-row">4. motive justificate, precum îngrijirea/ însoțirea unui minor/copilului,
        asistența
      </div>
      <div class="radio-text-row">persoanelor vârstnice, bolnave sau cu dizabilități ori deces al unui membru de familie</div>
    </div>
    <div class="radio-paragraph">
      <div class="radio-checkbox-row">
        <div class="radio {{reason_5}}"></div>
      </div>
      <div class="radio-text-first-row">5. activitate fizică individuală (cu excluderea oricăror activități
        sportive de echipă
      </div>
      <div class="radio-text-row">/ colective) sau pentru nevoile animalelor de companie/domestice, în apropierea locuinței
      </div>
    </div>
    <div class="radio-paragraph">
      <div class="radio-checkbox-row">
        <div class="radio {{reason_6}}"></div>
      </div>
  ...
  <div class="paragraph custom-container" style="text-align: center">
  ...
  <div style="font-weight: bold; font-size: 16px; width: 92%;">Persoanele care au împlinit vârsta de 65 de ani completează doar
